angular.module('momi-categories')
  .directive('tags', function(tagService){
    ...
    return {
		...
		controller:function($mdDialog,$scope,$rootScope,tagService,imageService,documentService,$sailsSocket,$stateParams,$state,usSpinnerService){
