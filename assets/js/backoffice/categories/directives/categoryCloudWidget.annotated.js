angular.module('core')
  .directive('categorycloudWidget', ["widgetService", "categoryService", function (widgetService,categoryService){
    var toto;
    'use strict';
...
//         $('#cloudCat').jQCloud('update',tmp);      
    ...
    return {
      ...
      controller:["$scope", "categoryService", "$state", function($scope,categoryService,$state){
