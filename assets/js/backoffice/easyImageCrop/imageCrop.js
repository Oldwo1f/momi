angular.module('core')
.directive('imageCrop', [function($compile){
	return {
		restrict: 'A',
	    templateUrl: 'js/backoffice/easyImageCrop/image-crop.html',
		scope:{
			aspectRatio:'=?',
			displayWidth: '=?',
			displayHeight: '=?',
...
console.log('TTTTTTTTTTTTTTTTTTTTTt');
					...
					imageCropSelector.style.background="url('"+newValue+"')"
					// imageCropSelector.style.backgroundImage = newValue;
					rectangleLeft = 0;
					rectangleTop = 0;
					rectangleWidth = 0;
					rectangleHeight = 0;
...
console.log('ON LOAD WATCH');
console.log($scope.currentImageWidth);
							$scope.containerWidth = $scope.currentImageWidth;
							$scope.containerHeight = $scope.currentImageHeight;

							$scope.scaleFactor = this.width / imageTag.offsetWidth;

							console.log($scope.scaleFactor);
							console.log(this.width + ' /// '+ imageTag.offsetWidth);
						};
...
console.log($scope.currentImageWidth);
				...
				originalImage.src = imageTag.src;
				var imageCropSelector = $window.document.getElementById("imageCropSelector");
				imageCropSelector.style.background="url('"+imageTag.src+"')"
			};
