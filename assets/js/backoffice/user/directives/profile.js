  ...
  .directive('profilePage', function(){
    ...
    return {
		...
		replace: true,
      	...
      	controller:function($mdDialog,$scope,$rootScope,userService,tagService,imageService,documentService,$sailsSocket,$stateParams,$state,usSpinnerService, $q, Upload,$timeout){
