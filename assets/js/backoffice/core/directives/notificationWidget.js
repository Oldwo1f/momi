angular.module('core')
  .directive('notificationWidget', function (widgetService,notificationService,$state){
    ...
    return {
      ...
      controller:function($scope,notificationService,$state,$sailsSocket,$rootScope){
