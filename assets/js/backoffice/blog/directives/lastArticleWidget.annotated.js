angular.module('core')
  .directive('lastarticleWidget', ["widgetService", "articleService", "$state", function (widgetService,articleService,$state){
    ...
    return {
      ...
      controller:["$scope", "articleService", "$state", function($scope,articleService,$state){
