angular.module('momi-blog')
  .directive('blog', ["articleService", function(articleService){
    ...
    return {
		...
		controller:["$scope", "$rootScope", "articleService", "tagService", "imageService", "documentService", "$sailsSocket", "$stateParams", "$state", "usSpinnerService", function($scope,$rootScope,articleService,tagService,imageService,documentService,$sailsSocket,$stateParams,$state,usSpinnerService){
