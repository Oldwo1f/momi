angular.module('momi-blog')
  .directive('blog', ["articleService", function(articleService){
    ...
    return {
		...
		controller:["$scope", "$rootScope", "userService", "articleService", "tagService", "imageService", "documentService", "$sailsSocket", "$stateParams", "$state", "usSpinnerService", function($scope,$rootScope,userService,articleService,tagService,imageService,documentService,$sailsSocket,$stateParams,$state,usSpinnerService){
