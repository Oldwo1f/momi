...
.directive('addProject', function(){
    ...
    return {
      	...
      	controller:["$state", "$timeout", "$scope", "userService", "$rootScope", "projectService", "$mdToast", "imageService", "documentService", "tagService", "categoryService", "$q", "Upload", "$sailsSocket", function($state,$timeout,$scope,userService,$rootScope,projectService,$mdToast,imageService,documentService, tagService, categoryService, $q, Upload,$sailsSocket){
