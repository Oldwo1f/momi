...
.controller('firstConnexionCtrl', ["$sailsSocket", "$rootScope", "$scope", "$auth", "$state", "$stateParams", "userService", function ($sailsSocket,$rootScope,$scope,$auth,$state,$stateParams,userService){
    // if (!$auth.isAuthenticated()) { return; }
    $scope.user={};
